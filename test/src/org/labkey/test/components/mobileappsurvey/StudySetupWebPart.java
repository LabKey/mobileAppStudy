...
public class StudySetupWebPart extends WebPart<StudySetupWebPart.ElementCache>
{
    ...
    public static class Locators extends org.labkey.test.Locators
    {
        ...
        protected static final Locator.XPathLocator shortNamePrompt = dataRegionLocator.append("//div[@id='labkey-mobileappsurvey-studysetup']//span/div/div/div[contains(@class, 'x4-panel-body')]/span/div");
