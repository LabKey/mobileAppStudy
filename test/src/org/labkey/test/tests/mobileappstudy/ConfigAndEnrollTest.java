...
//        waitForAlert(REUSED_STUDY_NAME_ERROR.replace("$STUDY_NAME$", STUDY_NAME02), 5000);
    ...
    {
        final String STUDY_NAME01 = "TOKENVALIDATION";
        final String PROJECT_NAME01 = getProjectName() + " Token Validation1";
        _containerHelper.deleteProject(PROJECT_NAME01, false);
        _containerHelper.createProject(PROJECT_NAME01, "Mobile App Study");
        goToProjectHome(PROJECT_NAME01);
        SetupPage setupPage = new SetupPage(this);
        ...
        cmd = new EnrollmentTokenValidationCommand(PROJECT_NAME01, STUDY_NAME01 + "_INVALIDSTUDYNAME", token, this::log);
        cmd.execute(400);
        ...
        log("Token validation action: no StudyId");
        cmd = new EnrollmentTokenValidationCommand(PROJECT_NAME01, null, token, this::log);
        cmd.execute(400);
        assertFalse("Enrollment token validation succeeded without the studyId", cmd.getSuccess());
        ...
        cmd = new EnrollmentTokenValidationCommand(PROJECT_NAME01, STUDY_NAME01, token + "thisIsAnInvalidToken", this::log);
        cmd.execute(400);
        ...
        cmd = new EnrollmentTokenValidationCommand(PROJECT_NAME01, STUDY_NAME01, null, this::log);
        cmd.execute(400);
        assertFalse("Enrollment token validation succeeded when it shouldn't have", cmd.getSuccess());
        assertEquals("Unexpected error message", EnrollmentTokenValidationCommand.TOKEN_REQUIRED, cmd.getExceptionMessage());

        final String STUDY_NAME02 = "BLANKTOKENVALIDATION";
        final String PROJECT_NAME02 = getProjectName() + " Token Validation2";
        _containerHelper.deleteProject(PROJECT_NAME02, false);
        _containerHelper.createProject(PROJECT_NAME02, "Mobile App Study");
        goToProjectHome(PROJECT_NAME02);
        setupPage = new SetupPage(this);
        ...
        cmd = new EnrollmentTokenValidationCommand(PROJECT_NAME02, STUDY_NAME02, null, this::log);
        cmd.execute(200);
