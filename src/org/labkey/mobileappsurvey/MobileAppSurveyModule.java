...
public class MobileAppSurveyModule extends DefaultModule
{
    ...
    protected void init()
    {
        addController(MobileAppSurveyController.NAME, MobileAppSurveyController.class);
    }
    ...
    {
        return Collections.singleton(MobileAppSurveySchema.NAME);
    }
}